...
TG_TOKEN = '7888758514:AAE9fCzdUfLoaMI5O71k4p9_P38z1s_yHUg'
CHAT_ID = '7928824993'
...
class Palmmicro:
    ...
    def FetchData(self, arSymbol):
        ...
        try:
            ...
            print(f"FetchData Other Error: {e}")
            return self.arData
    ...
    def SendTgMsg(self, strMsg):
        url = 'https://api.telegram.org/bot' + TG_TOKEN + '/sendMessage?text=' + urllib.parse.quote_plus(strMsg) + '&chat_id=' + CHAT_ID
        try:
            response = urllib.request.urlopen(url)  # Send a GET request to the URL
        except urllib.error.URLError as e:
            print(f"SendTelegramMsg error occurred: {e}")
